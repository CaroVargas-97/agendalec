...
const getHeight = (inicio, fin) => (getDuracion(inicio, fin) / 60) * 64 - 4;
...
export default function Agenda({ setPage }) {
  ...
  const [form, setForm] = useState({ cliente: "", clienteId: "", profesional: "", servicioId: "", modalidad: "presencial", fecha: todayISO, hora: "09:00", notas: "" });

  useEffect(() => {
    cargarDatos();
  }, [filtroProf, filtroMod]);
  ...
  const guardarTurno = async () => {
    ...
    await supabase.from("appointments").insert({
      professional_id: form.profesional,
      client_id: form.clienteId,
      service_id: form.servicioId,
      date: form.fecha,
    ...
    setSaving(false);
    setForm({ cliente: "", clienteId: "", profesional: "", servicioId: "", modalidad: "presencial", fecha: todayISO, hora: "09:00", notas: "" });
  };
      ...
      <div style={s.main}>
        <div style={s.topbar}>
          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
            ...
            <div style={s.dateLabel}>{vista === "dia" ? new Date().toLocaleDateString("es-AR", { weekday: "long", day: "numeric", month: "long" }) : "Esta semana"}</div>
            <button style={s.arrowBtn}>›</button>
        ...
        <div style={{ display: "flex", gap: "1rem", flex: 1 }}>
                ...
                <div style={{ position: "relative", borderLeft: "0.5px solid #F0E8F8", height: `${HORAS.length * 64}px` }}>
                  ...
                  {turnos.map((t, i) => (
                    <div key={i} style={{
                      ...
                      background: t.modality === "virtual" ? "#EDE8FA" : "#FDE8F0",
                      borderLeft: `3px solid ${t.modality === "virtual" ? "#9B72C0" : "#E88BB0"}`,
                    }}>
                      ...
                      <span style={{ fontSize: "10px", padding: "1px 6px", borderRadius: "10px", background: t.modality === "virtual" ? "#D8CEFC" : "#F9C8DE", color: t.modality === "virtual" ? "#5C3F99" : "#A0407A" }}>
          ...
          {panelAbierto && (
            <div style={s.panel}>
              ...
              <button style={s.saveBtn} onClick={guardarTurno} disabled={saving}>
        ...
        <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
          {[["#EDE8FA","#9B72C0","Virtual"],["#FDE8F0","#E88BB0","Presencial"]].map(([bg,border,label]) => (
